...
namespace BusinessLayer.ValidationRules
{
    public class GuideValidator : AbstractValidator<Guide>
    {
        public GuideValidator()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(30).WithMessage("Lütfen 30 karaterden daha kısa bir isim giriniz");
            RuleFor(x => x.Name).MinimumLength(8).WithMessage("Lütfen 8 karaterden daha uzun bir isim giriniz");
